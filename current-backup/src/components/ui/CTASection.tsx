      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <Text className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
            Join thousands of mothers who trust our app to guide them through
            every step of pregnancy and early motherhood.
          </Text>
        </motion.div>
        ...
        >
          <Text className="text-gray-600 max-w-xl mx-auto mb-6">
            Join over 10,000 mothers who have trusted our app to support them
            through their pregnancy journey. Download now and start experiencing
            the difference.
          </Text>
