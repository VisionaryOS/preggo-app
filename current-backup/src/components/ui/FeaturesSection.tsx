...
const features: Feature[] = [
  {
    ...
    description:
      "Follow your baby's development with detailed insights for each week of pregnancy.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Personalized meal plans and nutrition advice for each trimester.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Stay active with exercise routines specifically designed for pregnant women.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Access to articles, videos, and tips from OB-GYNs and midwives.",
    benefits: [
  ...
  firstTrimester: [
    {
      ...
      description:
        "Natural remedies and tips to help you manage nausea and maintain nutrition.",
    },
    {
      emoji: "💤",
      title: "Fatigue Solutions",
      description:
        "Strategies to cope with first-trimester exhaustion while maintaining your daily life.",
    },
    {
      emoji: "🗓️",
      title: "Appointment Scheduler",
      description:
        "Keeps track of your first vital doctor visits and reminds you of key screenings.",
    },
  ],
  secondTrimester: [
    {
    ...
    },
    {
      ...
      description:
        "Shopping guidance for comfortable clothes and pregnancy necessities.",
    },
    {
      emoji: "📸",
      title: "Pregnancy Photoshoot Ideas",
      description:
        'Creative ways to document your growing bump during the "golden trimester."',
    },
  ],
  thirdTrimester: [
    {
      ...
      description:
        "Techniques and position guides for better sleep as your belly grows.",
    },
    {
      emoji: "🏥",
      title: "Birth Plan Creator",
      description:
        "Interactive tool to develop and share your ideal birth experience with your providers.",
    },
    {
      emoji: "🧸",
      title: "Hospital Bag Checklist",
      description:
        "Comprehensive, customizable list so you're ready when the big day arrives.",
    },
  ],
};
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <Text className="mt-4 max-w-2xl text-xl text-gray-500 mx-auto">
            Designed by mothers, for mothers - with the tools and support you
            need at every stage.
          </Text>
        </div>
              ...
              >
                <div className="flex flex-col h-full">
                  ...
                  <div className="mt-auto">
                    <Text className="font-medium text-indigo-600 mb-2">
                      Why mothers love this:
                    </Text>
        ...
        <div className="mt-24">
          <div className="text-center mb-8">
            ...
            <Text className="text-gray-600">
              Our app adapts to your changing needs throughout your pregnancy
              journey
            </Text>
          </div>
          ...
          <Card>
            <TabGroup>
              ...
              <TabPanels>
                {(
                  Object.keys(trimesterFeatures) as Array<
                    keyof TrimesterFeatures
                  >
                ).map((trimester, i) => (
                  <TabPanel key={i}>
        ...
        >
          <Card className="bg-indigo-50 border-0">
            <div className="text-center py-6">
              <Title className="text-indigo-800">
                Ready to start your journey?
              </Title>
              <Text className="mb-6">
                Join thousands of mothers who trust our app every day
              </Text>
              <Link
                href="#get-started"
