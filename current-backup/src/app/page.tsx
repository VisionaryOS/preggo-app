...
const FEATURES = [
  {
    ...
    description:
      "Weekly updates on your baby's development with personalized insights.",
    emoji: "📊",
    color: "bg-blue-50",
  },
  {
    ...
    description:
      "Track symptoms and get AI-powered recommendations for relief.",
    emoji: "📝",
    color: "bg-purple-50",
  },
  {
    ...
    description:
      "Personalized nutrition advice for each trimester of your pregnancy.",
    emoji: "🥗",
    color: "bg-green-50",
  },
  {
...
const TESTIMONIALS = [
  {
    quote:
      "This app has been a lifesaver during my pregnancy journey. The weekly updates are so detailed!",
    name: "Sophie, 28 weeks",
    emoji: "😊",
  },
  {
    quote:
      "The symptom tracker helped me identify patterns and discuss them with my doctor. Highly recommend!",
    name: "Emma, new mom",
    emoji: "🌟",
  },
  {
    quote:
      "I love the nutrition guides - they've made healthy eating during pregnancy so much easier.",
      ...
      <main className="flex-grow">
        ...
        <section className="relative py-24 overflow-hidden">
          ...
          <div className="container-center relative z-10">
            <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
              ...
              >
                Your <span className="text-gradient">complete</span> pregnancy
                companion
              </motion.h2>
              ...
              >
                Track your journey, get personalized insights, and connect with
                a supportive community, all in one beautifully designed app.
              </motion.p>
              ...
              >
                <div className="flex -space-x-1 mr-3">
                  {["💙", "💜", "💕", "💖"].map((emoji, i) => (
                    <div
                      key={i}
                      className="w-8 h-8 rounded-full bg-background shadow-sm flex items-center justify-center text-sm"
                    >
                      {emoji}
                    </div>
                  ))}
          ...
          <div className="container-center">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                PregnancyPlus provides all the tools to navigate your pregnancy
        ...
        <section className="py-20 bg-secondary">
          <div className="container-center">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold mb-4">
                Loved by expecting mothers
              </h2>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Join thousands of women who have transformed their pregnancy
                journey with PregnancyPlus.
              </p>
            </div>
              ...
              <CardContent className="p-8 md:p-12">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-xl text-muted-foreground mb-8 max-w-2xl">
                    Join thousands of expecting mothers who trust PregnancyPlus
                    for a healthier, happier pregnancy experience.
                  </p>
                  <Link href="/signup">
                    <Button
                      size="lg"
      ...
      <footer className="border-t">
        <div className="container-center py-12">
          ...
          <div className="pt-8 mt-8 border-t flex flex-col md:flex-row justify-between items-center">
            <p className="text-muted-foreground">
              © 2025 PregnancyPlus. All rights reserved.
            </p>
